...
public static function logMetrics(): void
{
    ...
    try {
        ...
        // ========== START: NEW CODE - Database Time Metrics ==========
        // Add database query count if available (from Database.php via connection.php)
     ...
     * Log metrics after response is sent (called via shutdown function)
     */
    public static function logMetrics_Old2(): void
    {
        if (!self::$enabled || self::$requestStartTime === null) {
            return;
        }
