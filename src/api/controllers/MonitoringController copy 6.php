        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                /* Keep a subtle hover effect, but DO NOT make the whole card clickable */
                ...
                /* Expand icon is the only clickable trigger */
                .expand-icon {
                    margin-left: auto;
                    font-size: 20px;
                    color: var(--text-secondary);
        ...
        <body>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    // Open modal ONLY when expand icon is clicked
                ...
                function initializeCharts() {
                    ...
                    // Response Time Chart (4 lines: App p50/p95 + System p50/p95)
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result.status === 'success') {
                                ...
                                // Update Response Time Chart (4 lines: App p50/p95 + System p50/p95)
                                const appP50 = parseFloat(
                                    recentStats?.app?.p50_response_time ?? recentStats?.app?.p50responsetime ?? 0
                                );
                                const appP95 = parseFloat(
                                    recentStats?.app?.p95_response_time ?? recentStats?.app?.p95responsetime ?? 0
                                );
                                const systemP50 = parseFloat(
                                    recentStats?.system?.p50_response_time ?? recentStats?.system?.p50responsetime ?? 0
                                );
                                const systemP95 = parseFloat(
                                    recentStats?.system?.p95_response_time ?? recentStats?.system?.p95responsetime ?? 0
                                );
